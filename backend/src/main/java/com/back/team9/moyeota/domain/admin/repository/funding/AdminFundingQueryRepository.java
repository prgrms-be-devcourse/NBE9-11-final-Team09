package com.back.team9.moyeota.domain.admin.repository.funding;
...
public interface AdminFundingQueryRepository extends JpaRepository<Funding, Long> {
    ...
    @Query(
            value = """
                    select new com.back.team9.moyeota.domain.admin.dto.funding.AdminFundingListResponse(
                        f.fundingId,
                        f.member.memberId,
                        f.member.email,
                        f.title,
    ...
    @Query("""
        SELECT new com.back.team9.moyeota.domain.admin.dto.statistics.AdminFundingStatistics(
            COUNT(CASE
